...
const UpComing = (Prop) => {
  const LoadCount = useRef(1);
    const Url_Nowplaying = `https://api.themoviedb.org/3/movie/upcoming?api_key=${Prop.api_key}&language=en-US&page=1`
  ...
  useEffect(() => { 
    ...
    const LodMore=()=>{
      LoadCount.current += 1 ;
      const Url_Movie2 =`https://api.themoviedb.org/3/movie/upcoming?api_key=${Prop.api_key}&language=en-US&page=${LoadCount.current}`
